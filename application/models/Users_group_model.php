...
class Users_group_model extends CI_Model
{
     ...
     */
    function get_users_group($user_id)
    {
        return $this->db->get_where('users_groups',array('user_id'=>$user_id))->row_array();
    }
     ...
     */
    function update_users_group($user_id,$params)
    {
    ...
    function inup_group($user_id, $group_id)
    {
