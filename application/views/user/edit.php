<?php echo form_open('user/edit/'.$user['id'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		<label for="ac_online" class="col-md-4 control-label">Ac Online</label>
		<div class="col-md-8">
			<input type="checkbox" name="ac_online" value="1" <?php echo ($user['ac_online']==1 ? 'checked="checked"' : ''); ?> id='ac_online' />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		<label for="ac_image" class="col-md-4 control-label">Ac Image</label>
		<div class="col-md-8">
			<input type="text" name="ac_image" value="<?php echo ($this->input->post('ac_image') ? $this->input->post('ac_image') : $user['ac_image']); ?>" class="form-control" id="ac_image" />
		</div>
	</div>
