<?php echo form_open('user/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="checkbox" name="ac_online" value="1" id="ac_online" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="ac_image" value="<?php echo $this->input->post('ac_image'); ?>" class="form-control" id="ac_image" />
		</div>
	</div>
