...
$config['default_group']              = 'verificador';           // Default group, use name
...
$config['user_expire']                = 86400;  // 24hours   // How long to remember the user (seconds). Set to zero for no expiration
